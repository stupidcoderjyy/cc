...
private:
    ...
    bool print_conflict_info_ = true;
    ...
    static void PrintReduce(int group_id, const Symbol& forward, const Production& prod);
    static void PrintGoto(int group_id, const Symbol& input, int nextState);
    static void PrintShift(int group_id, const Symbol& input, int nextState);
    static void PrintAccept(int group_id, const Symbol& forward);
